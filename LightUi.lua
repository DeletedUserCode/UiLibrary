...
local Library = {
    ...
    AccentColor = Color3.fromRGB(255, 255, 153);
...
function Library:CreateWindow(...)
    ...
    Library:GiveSignal(InputService.InputBegan:Connect(function(Input, Processed)
        ...
        elseif Input.KeyCode == Enum.KeyCode[_G.UiBind] or (_G.Keybind and Input.KeyCode.Name == _G.Keybind) or (Input.KeyCode == Enum.KeyCode[_G.UiBind] and (not Processed)) then
            task.spawn(Library.Toggle)
        end
